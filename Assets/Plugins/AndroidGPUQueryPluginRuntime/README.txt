...
if you want to monitor gpu timings of urp internal passes, just drag GPUTimingPrinter prefab which is under Asset/Plugins/GPUQueryPluginRuntime path into the scene directly.
