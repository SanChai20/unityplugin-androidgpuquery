...
if you want to monitor gpu timing of urp internal passes, just drag GPUTimingPrinter prefab which is under Asset/Plugins/GPUQueryPluginRuntime path into scene directly.
